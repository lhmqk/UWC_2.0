...
document.getElementById("event-form").onsubmit = (e) => {
    ...
    const title = form.querySelector("input#event-title");
    const employee = form.querySelector("input#event-employee");
    const details = form.querySelector("textarea#event-details");
  
    const data = JSON.stringify({
        title: title.value,
        start: form.querySelector('input#event-start').value,
        end: form.querySelector('input#event-end').value,
        employee: employee.value,
        details: details.value
    });

    title.value = employee.value = details.value = '';
    $form = $(e.currentTarget);
    $form.parent().blur().hide();
    // data
    console.log(data);
    // fetch('/api/assignTask?title=title', {
...
if(events.length===0){
events.push(
{id:1,title: 'event1', start: year + '-' + month + '-' + today + 'T07:00', end: year + '-' + month + '-' + today + 'T10:00', employee: 'The Moon', details: 'There will be cheese'},
{id:2,title: 'event2', start: year + '-' + month + '-' + tomorrow + 'T03:00', end: year + '-' + month + '-' + tomorrow + 'T08:00', employee: 'The Moon', details: 'There will be cheese'},
{id:3,title: 'event3', start: year + '-' + month + '-' + yesterday + 'T20:00', end: year + '-' + month + '-' + today + 'T05:00', employee: 'The Moon', details: 'There will be cheese'}
);
}
/*events.push(
{title: 'event1', start: year + '-' + month + '-' + today + 'T07:00', end: year + '-' + month + '-' + today + 'T10:00', employee: 'The Moon', details: 'There will be cheese'},
{title: 'event2', start: year + '-' + month + '-' + tomorrow + 'T03:00', end: year + '-' + month + '-' + tomorrow + 'T08:00', employee: 'The Moon', details: 'There will be cheese'},
{title: 'event3', start: year + '-' + month + '-' + yesterday + 'T20:00', end: year + '-' + month + '-' + today + 'T05:00', employee: 'The Moon', details: 'There will be cheese'}
);*/
